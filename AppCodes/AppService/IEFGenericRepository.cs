...
namespace project.AppCodes.AppService
{
    ...
    public interface IEFGenericRepository<TEntity>
    {
        ...
        /// 取得 Entity 全部筆數資料 (同步)
        /// </summary>
        ///  <param name="predcate">要取得的 Where 條件式</param>
        /// <returns>Entity 全部筆數的資料</returns>

        IQueryable<TEntity> ReadAll(Expression<Func<TEntity, bool>>predcate);
        ...
        Task<List<TEntity>> ReadAllAsync(Expression<Func<TEntity, bool>> predcate);
