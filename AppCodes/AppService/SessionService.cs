...
public static class SessionService
{
    ...
    public static string CountryNo
    {
        ...
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("CountryNo");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("CountryNo", value); }
    }
    /// <summary>
    /// 登入使用者部門名稱
    /// </summary>
    ...
    public static string ReviewStar
    {
        get
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("ReviewStar");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
    ...
    public static string CourseNo
    {
        ...
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("CourseNo");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("CourseNo", value); }
    }
    ...
    public static string CourseName
    {
        ...
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("CourseName");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("CourseName", value); }
    }
    ...
    public static string TeacherNo
    {
        ...
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("TeacherNo");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("TeacherNo", value); }
    }
    ...
    public static string TeacherName
    {
        ...
        {
            string str_value = "";
            if (_context != null) str_value = _context.Session.Get<string>("TeacherName");
            if (str_value == null) str_value = "";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("TeacherName", value); }
    }
    ...
    public static int PageSize
    {
        get
        {
            ...
            if (str_value == null) str_value = "10";
