...
{
    public class ABASP002_Category1sController : Controller
    {
        /// <summary>
        /// 資料初始化事件
        /// </summary>
        ...
        {
            using var datas = new z_repoCategory1s(SessionService.SortColumn, SessionService.SortDirection);
        ...
        public IActionResult CreateEdit(int id = 0)
        {
            ...
            {
                //修改資料
                using var datas = new z_repoCategory1s();
        ...
        [Login(RoleList = "Admin")]
        [HttpPost]
        public IActionResult CreateEdit(Category1s model)
        {
        ...
        public JsonResult DeleteRow(int id = 0)
        {
            ...
            using (z_repoCategory1s datas = new z_repoCategory1s())
            {
                datas.Delete(id);
