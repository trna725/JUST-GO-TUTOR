...
{
    public class MBASP003_Category2sController : Controller
    {
        /// <summary>
        /// 資料初始化事件
        /// </summary>
        ...
        {
            using var datas = new z_repoCategory2s(SessionService.SortColumn, SessionService.SortDirection);
        ...
        public IActionResult CreateEdit(int id = 0)
        {
            ...
            {
                //修改資料
                using var datas = new z_repoCategory2s();
        ...
        [Login(RoleList = "Mis")]
        [HttpPost]
        public IActionResult CreateEdit(Category2s model)
        {
        ...
        public JsonResult DeleteRow(int id = 0)
        {
            ...
            using (z_repoCategory2s datas = new z_repoCategory2s())
            {
                datas.Delete(id);
