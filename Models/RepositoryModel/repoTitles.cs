...
//        str_query = dpr.GetSQLSelectCommand(new Titles());
//        return str_query;
//    }
//    /// <summary>
//    /// 取得模擬搜尋的欄位集合
...
//        //由系統自動取得文字欄位的集合
//        using var dpr = new DapperRepository();
//        searchColumn = dpr.GetStringColumnList(new Titles());
//        return searchColumn;
//    }
//    /// <summary>
//    /// SQL 查詢條件式指令
...
//    /// 預設 SQL 排序指令
//    /// </summary>
//    private readonly string DefaultOrderByColumn = "Titles.TitleNo";
//    /// <summary>
//    /// 預設 SQL 排序方式指令
//    /// </summary>
...
//        if (showNo) str_query += "TitleNo + ' ' + ";
//        str_query += "TitleName AS Text , TitleNo AS Value FROM Titles ORDER BY TitleNo";
...
//        using var dpr = new DapperRepository();
//        str_query = dpr.GetSQLInsertCommand(new Titles());
//        return str_query;
//    }
//    /// <summary>
//    /// SQL 刪除指令
...
//        using var dpr = new DapperRepository();
//        str_query = dpr.GetSQLDeleteCommand(new Titles());
//        return str_query;
//    }
//    /// <summary>
//    /// SQL 修改指令
...
//        using var dpr = new DapperRepository();
//        str_query = dpr.GetSQLUpdateCommand(new Titles());
//        return str_query;
//    }
//    #endregion
//    #region 物件建構子
...
//    public z_repoTitles(string orderByColumn, string orderByDirection)
//    {
...
//    /// <returns></returns>
//    public Titles GetData(int id)
//    {
//        var model = new Titles();
//        if (id == 0)
//        {
//            //新增預設值
//        }
...
//                //parm.Add("參數名稱", "參數值");
//            }
//            model = dpr.ReadSingle<Titles>(sql_query, parm);
//        }
//        return model;
//    }
//    /// <summary>
...
//    /// <returns></returns>
//    public List<Titles> GetDataList(string searchString = "")
//    {
//        List<string> searchColumns = GetSearchColumns();
//        DynamicParameters parm = new DynamicParameters();
//        var model = new List<Titles>();
//        using var dpr = new DapperRepository();
//        string sql_query = GetSQLSelect();
//        string sql_where = GetSQLWhere();
//        sql_query += sql_where;
//        if (!string.IsNullOrEmpty(searchString))
//            sql_query += dpr.GetSQLWhereBySearchColumn(new Titles(), searchColumns, sql_where, searchString);
//        if (!string.IsNullOrEmpty(sql_where))
//        {
//            //自定義的 Weher Parm 參數
//            //parm.Add("參數名稱", "參數值");
//        }
//        sql_query += GetSQLOrderBy();
//        model = dpr.ReadAll<Titles>(sql_query, parm);
//        return model;
//    }
//    /// <summary>
//    /// 新增或修改資料(同步呼叫)
...
//    /// </summary>
//    /// <param name="model">資料模型</param>
//    public void Create(Titles model)
//    {
//        using var dpr = new DapperRepository();
...
//    {
//        using var dpr = new DapperRepository();
//        string str_query = dpr.GetSQLDeleteCommand(new Titles());
//        DynamicParameters parm = dpr.GetSQLDeleteParameters(new Titles(), id);
//        dpr.Execute(str_query, parm);
//    }
//    #endregion
...
//    /// <param name="id">Key 欄位值</param>
//    /// <returns></returns>
//    public async Task<Titles> GetDataAsync(int id)
//    {
//        var model = new Titles();
//        if (id == 0)
//        {
...
//                //parm.Add("參數名稱", "參數值");
//            }
//            model = await dpr.ReadSingleAsync<Titles>(sql_query, parm);
//        }
//        return model;
//    }
//    /// <summary>
...
//    /// <param name="searchString">模糊搜尋文字(空白或不傳入表示不搜尋)</param>
//    /// <returns></returns>
//    public async Task<List<Titles>> GetDataListAsync(string searchString = "")
//    {
//        List<string> searchColumns = GetSearchColumns();
//        DynamicParameters parm = new DynamicParameters();
//        var model = new List<Titles>();
...
//        }
//        sql_query += GetSQLOrderBy();
//        model = await dpr.ReadAllAsync<Titles>(sql_query, parm);
//        return model;
//    }
//    /// <summary>
//    /// 新增或修改資料(非同步呼叫)
...
//    /// <param name="model">資料模型</param>
//    /// <returns></returns>
//    public async Task CreateEditAsync(Titles model)
//    {
//        if (model.Id == 0)
...
//    /// <param name="model">資料模型</param>
//    /// <returns></returns>
//    public async Task CreateAsync(Titles model)
//    {
//        using var dpr = new DapperRepository();
//        string str_query = dpr.GetSQLInsertCommand(model);
//        DynamicParameters parm = dpr.GetSQLInsertParameters(model);
...
//    /// <param name="model">資料模型</param>
//    /// <returns></returns>
//    public async Task EditAsync(Titles model)
//    {
//        using var dpr = new DapperRepository();
//        string str_query = dpr.GetSQLUpdateCommand(model);
//        DynamicParameters parm = dpr.GetSQLUpdateParameters(model);
